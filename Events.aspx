<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="Events.aspx.cs" Inherits="AIRPORT_HOTEL.Events" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row" style="margin:auto; display: flex; align-items: center; justify-content: center;">
        <div class="col-sm-4" style="display: flex; flex-direction: row; align-items: center;">
            <img src="events.jpg" style="width: 550px; height: 283px; border: 2px solid #c6b452; box-shadow: 5px 5px 15px rgba(0, 0, 0, 0.3); margin-right: 20px; margin-top: 45px;" />
            <div class="col-sm-5" style="width: 400px; margin-top: 40px;">
                <h7 style="color:#054305; font-size: 23px; margin-bottom: 10px;"><b>EVENTS</b></h7>
